...
`Binary releases are available at GitHub. <https://github.com/danilshik/imposm3custom/releases>`_
...
Please see `the README for build instructions <https://github.com/danilshik/imposm3custom/#installation>`_.
