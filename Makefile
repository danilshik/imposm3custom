...
VERSION_LDFLAGS=-X github.com/danilshik/imposm3custom.Version=$(BUILD_VERSION)
...
%.pb.go: %.proto
	protoc --proto_path=$(GOPATH)/src:$(GOPATH)/src/github.com/danilshik/imposm3custom/vendor/github.com/gogo/protobuf/protobuf:. --gogofaster_out=. $^
